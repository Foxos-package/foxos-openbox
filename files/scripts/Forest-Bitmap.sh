...
notify_user() {
	...
	dunstify -u normal --replace=699 -i /usr/share/foxos/icons/dunst/themes.png "Applying Style : ${style%.*}"
}
...
change_appearance 'Adapta-Nokto-Eta' 'foxos-Dark' 'Pear' 'Terminus Medium 9'
